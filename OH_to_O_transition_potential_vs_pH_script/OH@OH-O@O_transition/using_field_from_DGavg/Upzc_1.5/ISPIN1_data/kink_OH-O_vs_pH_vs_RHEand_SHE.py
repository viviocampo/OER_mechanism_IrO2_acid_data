...
def DG_diff_OH(URHE, pH):
    return DG_diff_OH_0 + (-0.04) * (-1.41) * (URHE - 0.059 * pH - 1.5) - 1 * URHE + (-0.08/2) * ((-1.41) * (URHE - 0.059 * pH - 1.5))**2 - 1 * URHE

def DG_diff_O(URHE, pH):
    return DG_diff_O_0 + (-0.17) * (-1.41) * (URHE - 0.059 * pH - 1.5) - 2 * URHE + (-0.05/2) * ((-1.41) * (URHE - 0.059 * pH - 1.5))**2 - 2 * URHE
